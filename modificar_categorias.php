<?php 
    ...
    $consulta_datos = $conexion->query("SELECT * FROM categorias WHERE id_categoria = $id;");
...
?>
        ...
        <head>
            ...
            <title>🛠️ Ferreteria | Modificar Categorias</title>
            <!--Bootstrap CSS-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light color_navbar p-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav d-flex align-items-center justify-content-center"> 
                        <li class="nav-item">
                             <a class="nav-link active" aria-current="page" href="categorias.php" style="color:#843C0C;">Salir</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container-fluid columns d-flex align-items-center justify-content-center">  
                <form class="col-3 pt-4" method="POST">
                        <h3 class="text-center color_h3">Modificar Categorias</h3>
                        
                        <input type="hidden" name="id" value="<?php echo $_GET["id"]; ?>">

                        <?php
                            include "controller/modificar_categorias.php";
                            //Obtener una sola fila de resultados
                            while($datos=$consulta_datos->fetch_object()){ 
                        ?>
                        <div class="mb-1 mt-5">
                            <label for="exampleInputEmail1" class="form-label">Categoria:</label>
                            <input type="text" class="form-control" name="categoria" value="<?= $datos -> nombre_categoria ?>" onkeyup="mayus(this);"> 
                        </div>
                        <?php          
                            }
                        ?>
