<?php 
    ...
    $consulta_datos = $conexion->query("SELECT cantidad_comprada, descripcion_producto, nombre_proveedor FROM detallecompras 
    INNER JOIN proveedores ON detallecompras.id_proveedor = proveedores.id_proveedor
    ...
    ?>
        ...
        <head>
            ...
            <title>🛠️ Ferreteria | Modificar Compras</title>
            <!--Bootstrap CSS-->
        ...
        <nav class="navbar navbar-expand-lg navbar-light color_navbar p-3">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav d-flex align-items-center justify-content-center"> 
                        <li class="nav-item">
                             <a class="nav-link active" aria-current="page" href="compras.php" style="color:#843C0C;">Salir</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="container-fluid columns d-flex align-items-center justify-content-center">  
                <form class="col-sm-3 col-md-3 pt-1" method="POST">
                        <h3 class="text-center color_h3">Modificar Compras</h3>
                        
                        <input type="hidden" name="id" value="<?php echo $_GET["id"]; ?>">

                        <?php   
                            include "controller/modificar_compras.php";
                        ?>
                        ...
                        <div class="mb-1">
                            ...
                            <select class="form-select" aria-label="Default select" name="descripcion_producto">
                                ...
                                <?php 
                                $sqlProductos = "SELECT DISTINCT descripcion FROM productos;";
                                $resultadoProductos = mysqli_query($conexion, $sqlProductos);
                                while ($consultaProducto = mysqli_fetch_array($resultadoProductos)) {
                                    $selected = ($consultaProducto['descripcion'] == $datos->descripcion_producto) ? 'selected' : '';
                                    echo '<option value="' . $consultaProducto['descripcion'] . '" ' . $selected . '>' . $consultaProducto['descripcion'] . '</option>';
                                } 
                                ?>
                            </select>
                        </div>          
                        ...
                        <div class="mb-1 mt-3">
                          ...
                          <input type="numer" class="form-control" name="cantidad_comprada" value="<?= $datos->cantidad_comprada ?>" onkeyup="mayus(this);">
                        </div>
